 ...
 * ================================================================
 */
mongoose.connect ('mongodb://localhost/test'); // todo - read from configuration.
...
var socketIOURL = "http://0.0.0.0:" + process.env.NODE_PORT;
...
app.post ('/api/data/file/add', function (request, response) {
    fileSystem.add (request, response);
    //sioClient.emit ('send:message', request.body);
});

app.post ('/api/data/graph/add', function (request, response) {
    graph.add (request, response, sioClient);
});
