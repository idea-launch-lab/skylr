...
module.exports.listen = function () {
    this.server.listen (core.config.service.port,  function () {
        logger.info ('System listening on port ' + core.config.service.port + '.');
    });
};
...
var socketIOURL = "http://0.0.0.0:" + core.config.service.port; //process.env.NODE_PORT;
...
app.post ('/api/data/kafka/add',    routes.messageQ.add);

// Analytics API
app.post ('/api/data/druid/query',  routes.druid.query);
