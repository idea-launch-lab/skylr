...
var socketURL = 'http://0.0.0.0:' + tutil.core.config.service.port;
 ...
 */    
describe('Test Socket.IO Interaction', function(){
    /**
	...
	it('Should broadcast new user to all users', function(done){
	    ...
	    logger.info ('> Socket.IO client connecting @ ' + socketURL);
